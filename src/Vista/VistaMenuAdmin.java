...
public class VistaMenuAdmin extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btn_recepcion.setFont(new java.awt.Font("The munday free version", 1, 14)); // NOI18N
        btn_recepcion.setForeground(new java.awt.Color(0, 102, 255));
        btn_recepcion.setText("RECEPCION");
        btn_recepcion.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                btn_recepcionFocusGained(evt);
            }
            public void focusLost(java.awt.event.FocusEvent evt) {
                btn_recepcionFocusLost(evt);
            }
        });
    ...
    private void btn_recepcionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_recepcionActionPerformed
        try {
            ...
            Logger.getLogger(VistaMenuAdmin.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btn_recepcionFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_btn_recepcionFocusGained
        // TODO add your handling code here:
        btn_recepcion.setBackground(new Color(187, 215, 243));
    }//GEN-LAST:event_btn_recepcionFocusGained

    private void btn_recepcionFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_btn_recepcionFocusLost
        // TODO add your handling code here:
        btn_recepcion.setBackground(new Color(255, 255, 255));
    }//GEN-LAST:event_btn_recepcionFocusLost
